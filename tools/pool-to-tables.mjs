 ...
 * stop here; everything else is content and travels through to the catalog untouched. `conditions`
 * is omitted rather than nulled when empty, because an absent array and an empty one mean the same
 * thing to every consumer and the shorter one is easier to read in a 6000-line generated file. */
